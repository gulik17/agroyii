...
<div class="row">
    <div class="col-lg-12">
        ...
        <h2 class="catalog__title-h2 title-h2">Вы искали: <?= Html::encode($q) ?></h2>

        <!--Sort-->

        <div class="catalog__sorting-block d-flex justify-content-between align-items-center">
            <p class="catalog__number">Найдено: <?= $pages->totalCount ?></p>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="catalog__card card">
                    ...
                    <div class="card__body">
                        <a href="<?= yii\helpers\Url::to(['product/view', 'id' => $product->id]) ?>" class="card__title link">Картофель «<?=$product->name?>», калибр 5+</a>
